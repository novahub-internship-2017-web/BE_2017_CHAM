      ...
      <div class="container">
         <div class="row main">
            <div class="main-login main-center">
               ...
               <form method="post" action="../QuanLyNhanSu/inforuser?action=update&userId=<%= teacher.getUserId() %>">
				...
				<div class="form-group">
				   ...
				   <select name ="degree">
				      <% System.out.print("Tiến Sĩ".equals(teacher.getDegree())); %>
				      <option size = "50" <% if ("Cử Nhân".equals(teacher.getDegree())){ %>selected <%} %> value="cn">Cử Nhân</option>
				      <option size = "50" <% if ("Thạc Sĩ".equals(teacher.getDegree())){ %>selected <%} %> value="ths">Thạc Sĩ</option>
				      <option size = "50" <% if ("Tiến Sĩ".equals(teacher.getDegree())){ %>selected <%} %> value="ts">Tiến sĩ</option>
				   </select>
				</div>
				<div class="form-group">
